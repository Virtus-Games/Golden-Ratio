...
public class EditorWindowsPrefab : EditorWindow {
    ...
    */
    [MenuItem ("EditorWindows/EditorWindowsPrefab")]
    static void ShowWindow () {
        //LevelTasarlamaAraci Tipindeki paneli, pencereyi oluşturup aktif hale getiriyoruz.
        var window = GetWindow<EditorWindowsPrefab> ();
        window.titleContent = new GUIContent ("Editor Windows Prefab");
        window.Show ();
    }
    ...
    void OnGUI () {
        ...
        GUILayout.Label ("Prefab Oluşturma");
